						...
						<fieldset>
							<legend>Στοιχεία Αποστολής</legend>
                                ...
                                <div class="formLayer">
                                    ...
                                    <div class="rightFormLayer"><p><input id="surname" type="text" name="textfield" value="ΣΚΟΥΡΑΔΑΚΗΣ"/></p></div>
                                </div>
                                <div class="clear"></div>  
 
                                <div class="formLayer">
                                    <div class="leftFormLayer"><p><label for="street">Οδός/Αριθμός<span class="required"> (Υποχρεωτικό) </span></label></p></div>
                                    <div class="rightFormLayer"><p><input id="street" type="text" name="textfield" value="ΠΑΝΕΠΙΣΤΗΜΙΟ ΗΥ564"/></p></div>
                                </div>
                                <div class="clear"></div>                                  
                                
   
                                <div class="formLayer">
                                    <div class="leftFormLayer"><p><label for="city">Πόλη<span class="required"> (Υποχρεωτικό) </span></label></p></div>
                                    <div class="rightFormLayer"><p><input id="city" type="text" name="textfield" value="ΗΡΑΚΛΕΙΟ"/></p></div>
                                </div>
                                <div class="clear"></div> 
 
                                <div class="formLayer">
                                    <div class="leftFormLayer"><p><label for="area">Περιοχή<span class="required"> (Υποχρεωτικό) </span></label></p></div>
                                    <div class="rightFormLayer"><p><input id="area" type="text" name="textfield" value="ΚΝΩΣΣΟΣ"/></p></div>
                                </div>
                                <div class="clear"></div>                                 							

                                <div class="formLayer">
                                    <div class="leftFormLayer"><p><label for="postal_code">Ταχυδρομικός κώδικας</label></p></div>
                                    <div class="rightFormLayer"><p><input id="postal_code" type="text" name="textfield" value="71409" /></p></div>
                                </div>
                                <div class="clear"></div>      	                                
								
                                <div class="formLayer">
                                    <div class="leftFormLayer"><p><label for="country">Χώρα<span class="required"> (Υποχρεωτικό) </span></label></p></div>
                                ...
                                <div class="formLayer">
                                    <div class="leftFormLayer"><p><label for="phone">Τηλέφωνο</label></p></div>
                                    <div class="rightFormLayer"><p><input id="phone" type="text" name="textfield" value="+302810393361"/></p></div>
                                </div>
                                <div class="clear"></div>      									
                                ...
                                <div class="formLayer">
                                    ...
                                    <div class="rightFormLayer"><p><input id="email" type="text" name="email" value="giannis@csd.uoc.gr" style="background: #FF3333"/></p></div>
                                </div>
                                <div class="clear"></div> 
                                ...
                                <div class="formLayer">
                                    ...
                                    <div class="rightFormLayer"><p><input id="emailconfirm" type="text" name="emailconfirm" value="gianni@csd.uoc.gr" style="background: #FF3333"/></p></div>
                                </div>
                                <div class="clear"></div>                                    
                    ...
                    <div class="box">
						...
						<fieldset>
                            ...
                            <div class="formLayer">
                                ...
                                <div class="rightFormLayer"><p><input id="card_number" type="text" name="card_number" value="456730560000987" style="background: #FF3333"/></p></div>
                            </div>
                            <div class="clear"></div>     
                            ...
                            <div class="formLayer">
                                ...
                                <div class="rightFormLayer"><p><input id="ccv2" type="text" name="textfield" maxlength="3" size="3" value="424"/><a href="#" title="ccv πληροφορίες">[help]</a></p></div>
                            </div>
                            <div class="clear"></div>                                 
