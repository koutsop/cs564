 ...
 * @author koutsop
 */
public class AdaptableSettingsView extends javax.swing.JPanel {
    final static String noDisability = "NoDisabilitySettingsView";
    final static String viewB = "ViewB";
    JPanel p = new JPanel(new CardLayout());
    
    /** Creates new form AdaptableIMView */
    public AdaptableSettingsView() {
        initComponents();
        
        p.add(new NoDisabilitySettingsView(), noDisability);
