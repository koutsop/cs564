 ...
 * @author koutsop
 */
public class SuccessfulGroupModification extends javax.swing.JPanel {

	/** Creates new form SuccessfulGroupCreation */
	public SuccessfulGroupModification() {
		initComponents();
	}
    ...
    private void initComponents() {
        ...
        adaptiveLabel1.setText("Επιτυχής Τροποποίηση Ομάδας");
